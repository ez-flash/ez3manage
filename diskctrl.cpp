// DiskCtrl.cpp : implementation file
//
...
extern CString m_gStrMsgInstallOSUp;//=正在升级EZ3操作系统...
...
extern CString m_gStrMsgDownLoadEnd;//=正在下载数据文件结束,请重新安装EZ3操作系统;
CDiskCtrl::CDiskCtrl()
{
}
...
BEGIN_MESSAGE_MAP(CDiskCtrl, CListCtrl)
	//{{AFX_MSG_MAP(CDiskCtrl)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	ON_WM_DRAWITEM()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CDiskCtrl::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
